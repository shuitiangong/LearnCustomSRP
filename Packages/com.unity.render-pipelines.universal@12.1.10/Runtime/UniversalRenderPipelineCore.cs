...
namespace UnityEngine.Rendering.Universal
{
    ...
    public static class ShaderKeywordStrings
    {
        ...
        public static readonly int TempTargetId = Shader.PropertyToID("_TempTargetTestBlur");
        public static readonly int FocusPowerId = Shader.PropertyToID("_FocusPower");
        public static readonly int focusDistanceMinId = Shader.PropertyToID("_FocusDistanceMin");
        public static readonly int focusDistanceMaxId = Shader.PropertyToID("_FocusDistanceMax");
        public static readonly int farBlurScaleId = Shader.PropertyToID("_farBlurScale");
        public static readonly int nearBlurScaleId = Shader.PropertyToID("_nearBlurScale");
        public static readonly int farBlurScalePowerId = Shader.PropertyToID("_farBlurScalePower");
        public static readonly int nearBlurScalePowerId = Shader.PropertyToID("_nearBlurScalePower");
